    ...
    <>
      <div className='home' id='home'>
        <div className="innerHome" data-aos='fade-down' data-aos-delay="500">
            ...
            <a href="https://drive.google.com/file/d/1IoOw3gOg-w2ScfX4JkdYX1y4WGmdv2ve/view?usp=share_link" target="_blank" rel="noreferrer" ><button className='btn-invert'>resume</button></a>
